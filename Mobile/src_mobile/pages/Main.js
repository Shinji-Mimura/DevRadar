...
function Main( {navigation} ){
    ...
    <>    
        ...
        <View style={styles.searchForm}>
            ...
            <TextInput style={styles.searchInput} placeholder = "Busque por tecnologias... " placeholderTextColor="#999" autoCapitalize="words" autoCorrect = {false} value={techs} onChangeText={setTechs}>
